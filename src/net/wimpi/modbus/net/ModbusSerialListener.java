...
public class ModbusSerialListener {
   ...
   */
  public ModbusSerialListener(UsbManager UsbManager, UsbSerialParameters params) {
    m_SerialCon = new SerialConnection(UsbManager, params);
  ...
  private void listen() {
    try {
      m_Listening = true;
      m_SerialCon.connect(Modbus.DEFAULT_TIMEOUT);
