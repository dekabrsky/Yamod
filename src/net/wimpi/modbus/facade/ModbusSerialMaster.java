...
public class ModbusSerialMaster {
	...
	private UsbSerialParameters m_CommParameters;
	 ...
	 */
	public ModbusSerialMaster(UsbManager UsbManager, UsbSerialParameters param) {
		try {
			m_CommParameters = param;
			m_Connection = new SerialConnection(UsbManager, m_CommParameters);
