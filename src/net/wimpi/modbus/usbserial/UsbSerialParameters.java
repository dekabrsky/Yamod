 ...
 */
public class UsbSerialParameters {
   ...
   */
  public UsbSerialParameters(String portName,
                             int baudRate,
                             int flowControlIn,
                             int flowControlOut,
                             int databits,
   ...
   *               other properties.
   */
  public UsbSerialParameters(Properties props, String prefix) {
    if (prefix == null) {
      prefix = "";
    }
